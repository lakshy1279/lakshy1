...
class Offering_Banner extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            heading: "",
    ...
    async componentDidMount() {
        let res = await axios.get("https://lakshy12.herokuapp.com/offering/fetch_banner");
    ...
    handleChange(event) {
       ...
       handleSubmit(e) {
        ...
        axios
            .post(
                "https://lakshy12.herokuapp.com/offering/add_banner",
                formdata
            )
...
export default Offering_Banner;
