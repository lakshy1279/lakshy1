...
class Organisation_Banner extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            heading: "",
    ...
    async componentDidMount() {
        let res = await axios.get("https://lakshy12.herokuapp.com/organisation/fetch_banner");
    ...
    handleChange(event) {
       ...
       handleSubmit(e) {
        ...
        axios
            .post(
                "https://lakshy12.herokuapp.com/organisation/add_banner",
                formdata
            )
...
export default Organisation_Banner;
