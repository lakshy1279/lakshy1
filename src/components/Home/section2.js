...
class Section2 extends React.Component {
    ...
    async componentDidMount() {
        let res = await axios.get("https://lakshy12.herokuapp.com/home/fetch_section1");
    ...
    handleChange(event) {
       ...
       handleSubmit(e) {
        ...
        axios
            .post(
                "https://lakshy12.herokuapp.com/home/add_section1",
                formdata
            )
            ...
            <div>
                ...
                <div className="admin-wrapper col-12">
                    <div className="admin-content">
                        <div className="admin-head">Section1</div>
